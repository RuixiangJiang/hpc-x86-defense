...
def main() -> int:
    ...
    text = [
        "=== When Randomness Isn't Random: operation-level session-calibrated detector ===",
        'Baseline, all attacks, and every PMU pass use the same wrir_single executable.',
