...
META_COLUMNS = {
    ...
    'intended_domain_index', 'used_domain_index', 'semantic_valid',
    'fault_applied', 'differs_intended', 'intended_seed_tag',
    'used_seed_tag', 'intended_output_tag', 'output_tag',
...
def main() -> int:
    ...
    if not candidate_features:
        raise SystemExit('[error] no PMU features satisfy all session coverage requirements')
    ...
    report = {
        'paper': "Valsaraj et al., When Randomness Isn't Random",
    ...
    print(
        f"=== When Randomness Isn't Random: {family} "
