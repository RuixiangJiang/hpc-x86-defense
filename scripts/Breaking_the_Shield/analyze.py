...
META_COLUMNS = {
    ...
    'target_kind', 'shake_full_blocks_intended',
    'shake_full_blocks_used', 'shake_skipped_block',
    'polyz_target_coeff', 'polyz_target_input_byte',
    'polyz_substitute_value', 'changed_units',
...
def main() -> int:
    ...
    report = {
        'paper': "Valsaraj et al., Breaking the Shield",
