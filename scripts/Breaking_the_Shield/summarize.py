...
def main() -> int:
    ...
    text = [
        "=== Breaking the Shield: operation-level session-calibrated detector ===",
        'Baseline, all attacks, and every PMU pass use the same bts_single executable.',
