...
echo "[1/6] build and verify the unpolluted target window"
...
rm -f \
    ...
    "$RESULT_DIR/attack_zero_twiddle.log" \
...
echo "[5/6] collect 500 zero-twiddle attack signatures"
...
python3 "$SCRIPT_DIR/analyze_fpr_tpr.py" \
    ...
    --attack "$RESULT_DIR/attack_zero_twiddle.csv" \
