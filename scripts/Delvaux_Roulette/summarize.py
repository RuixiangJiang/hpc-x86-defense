...
def main() -> int:
    ...
    text = [
        "=== Delvaux Roulette: operation-level session-calibrated detector ===",
        'Baseline, all attacks, and every PMU pass use the same rou_single executable.',
