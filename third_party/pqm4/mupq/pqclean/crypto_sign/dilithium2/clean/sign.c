...
#include "sign.h"
#include "symmetric.h"
/* BEGIN HPC-X86 JENDRAL HEDGED INCLUDE */
#ifdef PQCLEAN_DILITHIUM2_JENDRAL_X86
#include "jendral_hedged_fault_x86.h"
#endif
/* END HPC-X86 JENDRAL HEDGED INCLUDE */
...
int PQCLEAN_DILITHIUM2_CLEAN_crypto_sign_signature(uint8_t *sig,
    ...
    /* BEGIN HPC-X86 JENDRAL HEDGED SEED DERIVATION */
#ifdef PQCLEAN_DILITHIUM2_JENDRAL_X86
    if (PQCLEAN_DILITHIUM2_CLEAN_jendral_derive_rhoprime(
            rhoprime, key, mu) != 0) {
        return -1;
    }
#elif defined(PQCLEAN_DILITHIUM2_KRAHMER_X86)
...
#endif
    /* END HPC-X86 JENDRAL HEDGED SEED DERIVATION */
...
rej:
    ...
    /* BEGIN HPC-X86 JENDRAL NONCE AUDIT */
#ifdef PQCLEAN_DILITHIUM2_JENDRAL_X86
    PQCLEAN_DILITHIUM2_CLEAN_jendral_record_nonce(nonce);
#endif
    /* END HPC-X86 JENDRAL NONCE AUDIT */
